...
<head>
  ...
  <style>
    ...
    .btn-cancel:hover{
      transform: translateY(-3px);
      box-shadow: 0 0 20px rgb(228, 82, 82);
    }
...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top">
        <h3 class="welcome-sub-text" style="text-decoration:underline;"><b>EDIT USER</b> </h3>
        <hr>
 ...
 <!-- /*************************************************************************SIDENAVBAR************************************************************* */ -->
      ...
      <div class="main-panel">
        <div class="content-wrapper" id="edit-table">
          <div class="row">
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="edit-user">
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label"><b>Name<span
                            class="mandatory-field">*</span></b></label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="edit-name" placeholder="Username" required>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label"><b>Password<span
                            class="mandatory-field">*</span></b></label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="edit-password" placeholder="Password" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputPassword2" class="col-sm-3 col-form-label"><b>Designation<span
                            class="mandatory-field">*</span></b></label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="edit-designation" placeholder="Designation"
                          required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label"><b>Role<span
                            class="mandatory-field">*</span></b></label>
                      <div class="col-sm-4">
                        <!-- <input type="text" class="form-control" id="edit-role" placeholder="Role" required> -->
                        <select id="edit-role" name="role" class="form-control edit-role" required>
                      ...
                      <label for="exampleInputConfirmPassword2" class="col-sm-2 ms-10px col-form-label"><b id="status">Status<span
                        class="mandatory-field">*</span></b></label>
                  <div class="col-sm-3">
                    <select id="edit-status" name="status" class="form-control edit-status" required>
                    ...
                    <button type="submit" class="btn btn-primary me-2 btn-submit" id="editsubmit">Submit</button>
...
<script>
  $(document).ready(function () {
    ...
    function fetchUserDetails(userId) {
      ...
      var apiurl = 'https://dev-aniwatch.gateway.apiplatform.io/v1/users/' + userId;
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $('#edit-designation').val(user.designation);
    ...
    $('#edit-user').submit(function (event) {
      ...
      var formData = {
        ...
        password: parseInt($('#edit-password').val()),
        designation: $('#edit-designation').val(),
