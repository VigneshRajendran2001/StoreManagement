    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top">
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <div class="ms-auto">
            <a href="/StoreManagement/dist/pages/tables/add-product.php" class="btn btn-primary btn-add-user"><i class="menu-icon fa fa-plus"></i>Add
              Product</a>
          </div>
        </ul>
          ...
          "columns": [
             ...
             },
            {
              ...
              "render": function (data, type, row) {
                var editUrl = '<a href="/StoreManagement/dist/pages/tables/edit-product.php?id=' + row.id + '"><i class="fa fa-pencil-square-o icon-button" title="Click to Edit"></i></a>';
