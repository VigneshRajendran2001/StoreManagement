  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top">
        <h3 class="welcome-sub-text" style="text-decoration:underline;"><b>EDIT CATEGORY</b> </h3>
        <hr>
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="edit-category">
                    ...
                    <div class="form-group row">
                      <label for="exampleInputEmail2" class="col-sm-3 col-form-label"><b>Category Code<span
                            class="mandatory-field">*</span></b></label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="category_code" id="edit_category_code"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="file" class="form-control-file custom-file-upload" name="category_img"
                          id="edit_category_img" placeholder="Category Image">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                      <select id="edit_category_status" name="status" class="js-example-basic-single w-100 category-status " required>
                    ...
                    <!-- <div class="form-group row">
                      ...
                      <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label"><b
                          id="status">Status<span class="mandatory-field">*</span></b></label>
                      <div class="col-sm-9">
                        <select id="edit_category_status" name="status" class="form-control category-status" required>
                          <option value="">Select a status</option>
                    ...
                    <div class="form-group row">
                      <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label"><b>Description<span
                            class="mandatory-field"></span></b></label>
                      <div class="col-sm-9">
                        <textarea class="form-control" name="description" id="edit_category_description"
...
function fetchCategoryDetails(userId) {
  // var userId = getUrlParameter('id');

  var apikey = 'xgGEHQTWl89KsFPHojMIw7Q3YbACaJwF';
  var pkey = '3fdee6c11c06f9a43fe21eefcdfb5bd7';
  var apiurl = 'https://dev-aniwatch.gateway.apiplatform.io/v1/category/' + userId;
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $('#edit_category_code').val(category.category_code);
    //   $('#edit_category_img').val(category.category_img);
    //   $('#edit-category-price').val(category.price);
...
$('#edit-category').on('submit', function (e) {
  ...
  var formData = {
    ...
    // price: parseInt($('#edit-category-price').val()),
    status: parseInt($('#edit_category_status').val()),
    description: $('#edit_category_description').val()
  };

  var fileInput = $('#edit_category_img')[0];
