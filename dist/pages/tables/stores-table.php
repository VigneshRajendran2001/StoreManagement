  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top">
        <h3 class="welcome-sub-text" style="text-decoration:underline;"><b>STORES LIST</b> </h3><hr>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <!-- <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="ms-auto">
              <a href="/StoreManagement/dist/pages/tables/add-store.php" class="btn btn-primary btn-add-user"><i class="menu-icon fa fa-plus"></i>Add Store</a>
          </div>
        </ul>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3 class="card-title"><b>STORES LIST</b></h3>
        ...
        var table = $('#stores-table').DataTable({
                ...
                "columns": [
                    ...
                    { "data": "store_img",
                        ...
                        if(data){
                        var imagePath = '/StoreManagement/dist/assets/images/storeImages/' + data ;
                    ...
                    { 
                        "data": "status",
                        "render": function (data) {
                           var badge = data == 1 ? 'badge badge-primary' : 'badge badge-warning' ;
                           var statusText =  data == 1 ? 'Open' : 'Closed' ;
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row) {
                            var editUrl = '<a href="/StoreManagement/dist/pages/tables/edit-store.php?id=' + row.id + '"><i class="fa fa-pencil-square-o icon-button" title="Click to Edit"></i></a>';
