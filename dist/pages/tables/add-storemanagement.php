  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top">
        <h3 class="welcome-sub-text" style="text-decoration:underline;"><b>STORE MANAGEMENT</b> </h3>
        <hr>
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="add-storemanagement">
                  ...
                  <div class="form-group row">
                    <label  for="exampleInputEmail2" class="col-sm-3 col-form-label"><b>Store Name<span
                      ...
                      <div class="col-sm-7">
                      <select class="js-example-basic-multiple w-100"  multiple="multiple" name="storeName[]" id="add-storeName" required >
                     ...
                     >Store Manager <span class="mandatory-field">*</span></b></label>

                      <div class="col-sm-7">
                      <select id="add-storeManager" name="storeManager" class="js-example-basic-single w-100 " required>
                    ...
                    <label  for="exampleInputEmail2" class="col-sm-3 col-form-label"><b>Store Manager<span
                      class="mandatory-field">*</span></b></label>
                      <div class="col-sm-7">
                      <select class="js-example-basic-multiple w-100"  multiple="multiple" name="storeManager[]" id="add-storeManager" required >
...
<!-- <div class="form-group row">
                      <label for="exampleInputCategory" class="col-sm-3 col-form-label"><b
                     >Product <span class="mandatory-field">*</span></b></label>

                      <div class="col-sm-7">
                      <select id="add-product" name="product" class="js-example-basic-single w-100 " required>
                      ...
                      <div class="form-group row">
                           <label  for="exampleInputEmail2" class="col-sm-3 col-form-label"><b>Product<span
                            class="mandatory-field">*</span></b></label>
                         <div class="col-sm-7">
                            <select class="js-example-basic-multiple w-100"  multiple="multiple" name="product[]" id="add-product" required >
                              <option value=" ">Select the Product</option>
                    ...
                    <label  for="exampleInputEmail2" class="col-sm-3 col-form-label"><b>Category<span
                      class="mandatory-field">*</span></b></label>
                      <div class="col-sm-7">
                      <select class="js-example-basic-multiple w-100"  multiple="multiple" name="category[]" id="add-category" required >
                    ...
                    <label  for="exampleInputEmail2" class="col-sm-3 col-form-label"><b>Sub Category<span
                      class="mandatory-field">*</span></b></label>
                      <div class="col-sm-7">
                      <select class="js-example-basic-multiple w-100"  multiple="multiple" name="subcategory[]" id="add-subcategory" required >
                      ...
                      <label for="exampleInputPassword2" class="col-sm-3 col-form-label"><b>Quantity<span
                            class="mandatory-field">*</span></b></label>
                      <div class="col-sm-3">
                        <input type="text" class="form-control" name="quantity" id="add-quantity" placeholder="Quantity"
                          required>
                      </div>
                      ...
                      <div class="col-sm-3">
                        <select id="add-status" name="status" class="form-control product-status" required>
                ...
                <input type="text" class="form-control" name="date" id="add-date">
              </div>
              </div>
              </div>
...
<script>
  $(document).ready(function () {
    ...
    $('#add-storemanagement').on('submit', function (e) {
      e.preventDefault();

      var formData = {
        storeName: $('#add-storeName').val(),
        storeManager: $('#add-storeManager').val(),
        product: $('#add-product').val(),
        category:$('#add-category').val(),
        subcategory:$('#add-subcategory').val(),
