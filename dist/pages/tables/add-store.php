                  ...
                  <form class="forms-sample" id="add-store">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="file" class="form-control-file custom-file-upload" name="store_img"
                          id="store-img" placeholder="Store Image">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label"><b>Store Address<span
                            class="mandatory-field">*</span></b></label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="store_address" id="store-address"
                    ...
                    <label  for="exampleInputEmail2" class="col-sm-3 col-form-label"><b>Users<span
                      class="mandatory-field">*</span></b></label>
                      <div class="col-sm-3">
                      <select class="js-example-basic-multiple w-100" placeholder="Select the User" multiple="multiple" name="user_id[]" id="user-id" required >
                    ...
                    <div class="form-group row">
                      <label for="exampleInputEmail2" class="col-sm-3 col-form-label"><b>Mobile Number<span
                            class="mandatory-field">*</span></b></label>
                      <div class="col-sm-3">
                        <input type="text" class="form-control" name="mob_number" id="mob-number"
...
function fetchCategoriesData() {
       ...
       $.ajax({
           ...
           success: function(data) {
               ...
               $('#user-id').empty();
               // edit default option
               $('#user-id').append('<option value="">Select a category</option>');
...
/*********************************************************************** End Fetching user the user api ***********************************************/
    ...
    $('#add-store').on('submit', function (e) {
      ...
      var formData = {
        ...
        store_address: $('#store-address').val(),
        // price: parseInt($('#price').val()),
        // user_id: $('#user-id').val(),
        user_id: [],
        user_email: $('#user-email').val(),
        mob_number: $('#mob-number').val(),
        status: parseInt($('#store-status').val()),
      };
      ...
      if (fileInput.files.length > 0) {
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            setTimeout(function () {
              window.location = "/StoreManagement/dist/pages/tables/stores-table.html";
            }, 2000);
